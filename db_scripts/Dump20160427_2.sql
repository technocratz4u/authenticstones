...
--
-- Host: 127.0.0.1    Database: authentic_stones_db
-- ------------------------------------------------------
...
INSERT INTO `tbl_user_address` VALUES (1,5,'Rahul Aggarwal','9831148354','6565678999','4th Fl bangur Kolkata','Y',NULL,NULL,'Kolkata','WestBengal','700055','India'),(2,5,'Rahul','8765656756','67565757656','ugbvggfgyfgyfgfugyu','N',NULL,NULL,'Kolkata','WestBengal','700055','India');
...
INSERT INTO `tbl_user_cart` VALUES (273,6,1,221,'2016-04-26 14:09:47'),(274,6,3,16,'2016-04-26 14:09:47'),(275,6,4,160,'2016-04-26 14:09:47'),(276,6,6,3,'2016-04-26 14:09:47'),(293,8,1,224,'2016-04-26 14:11:36'),(294,8,3,16,'2016-04-26 14:11:36'),(295,8,4,160,'2016-04-26 14:11:36'),(296,8,6,3,'2016-04-26 14:11:36');
/*!40000 ALTER TABLE `tbl_user_cart` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'authentic_stones_db'
--
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_admin_authentication`(
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_delete_user_address`(
	IN in_user_id VARCHAR(20),
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_user_change_password`(
	IN in_user_id VARCHAR(20),
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_user_profile`(
	IN in_call_key VARCHAR(20),
	IN in_user_id VARCHAR(20),
...
-- Dump completed on 2016-04-27 15:54:54
