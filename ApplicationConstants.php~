...
if(__ENV=="PRODUCTION"){
	...
	define ('__WEB_ROOT', "/authenticstones");
	define ('__APPLICATION_NAME', "Authentic Stones");

	define ('__SERVER_NAME', "authenticstones-admspre.rhcloud.com"); // to be changed during deployment
	...
	define ('__APP_DB_HOST', "127.10.58.2");
	define ('__APP_DB_USER', "adminvQ4ejIA");
	define ('__APP_DB_PSWD', "_LZ7K7yviZDe");
	define ('__APP_SCHEMA', "authenticstones");
	...
	/********************** Paypal Constants ************************/
	define ('__PAYPAL_FORM_SUBMIT_URL', "https://www.sandbox.paypal.com/cgi-bin/webscr");
	define ('__PAYPAL_RETURN_URL', "http://localhost/paypal/handlesuccess");
	define ('__PAYPAL_CANCEL_URL', "http://localhost/paypal/handlecancel");
	define ('__PAYPAL_IPN_URL', "http://localhost/paypal/handleipn");
	define ('__PAYPAL_SELLER_ACCOUNT', "technocratz4u.seller1@gmail.com");
	define ('__PAYPAL_SELLER_IDENTITY', "pIs7juYuGKmJzI7m-Bl-MV2e1I3Yc1MvRqRnZPQ95bgpsrgfwQyBUL2n3NG");
